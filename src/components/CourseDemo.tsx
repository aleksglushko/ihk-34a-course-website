...
export default function CourseDemo({ onGetStarted }: { onGetStarted: () => void }) {
    ...
    return (
        <div className="py-8 bg-gradient-to-br from-green-50 to-blue-50 min-h-screen">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <button
                    ...
                    className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors shadow-lg hover:bg-blue-700"
                >
